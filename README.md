...
If you're working on a translation you'd like released with the next update of Delores, visit the [Thimbleweed Park Fourms](https://forums.thimbleweedpark.com/c/delores-engine) for more information and to connect with others doing translations.
